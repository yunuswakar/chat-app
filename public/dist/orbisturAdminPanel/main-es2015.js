...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>viewenquries works!</p>\n");
...
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
...
let AddCustomerComponent = class AddCustomerComponent {
    ...
    addCustomer() {
        ...
        this.service.postApi('admin/addCustomer', coutomerObject, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Customer has been added successfully.");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPackageManagementComponent", function() { return AddPackageManagementComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
...
let AddPackageManagementComponent = class AddPackageManagementComponent {
    constructor(service, router, formbuilder, spinner) {
        this.service = service;
        this.router = router;
        this.formbuilder = formbuilder;
    ...
    addpackage() {
        ...
        let object = {
            ...
            "packageCost": [{ 'hotelCategory': "9", 'hotelName': 'ads', 'pricePerAdult': 1950 },
                { 'hotelCategory': "9", 'hotelName': 'ads', 'pricePerAdult': 1950 }],
        ...
        // console.log('valid', this.addpackageForm.valid)
        this.service.postApi('admin/addPackage', object, 1).subscribe(res => {
            console.log(res);
            if (res.body.response_code == 200) {
                console.log(" this is the post api request -=-=-=-=-=-=-=", res);
                this.spinner.hide();
                this.service.showSuccess("Packages has been added successfully.");
    ...
    getCountry() {
        ...
        this.service.postApi('admin/countryList', object, 1).subscribe(res => {
            this.countryList = res.body.result.docs;
            console.log('countryListJson', this.countryList);
        });
    }
    // ***********************Destination List***************//
    destinationList() {
        let object = {};
        this.service.postApi('admin/destinationList', object, 1).subscribe(res => {
            this.destinationLists = res.body.result.docs;
            console.log('destinationLists==>>', this.destinationLists);
        });
    }
    ...
    packageList() {
        ...
        this.service.postApi('admin/packageTypeList', object, 1).subscribe(res => {
            console.log('packagessss', res);
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.packageLists = res.body.result.docs ? res.body.result.docs : res.body.result;
            }
        }, error => {
            this.spinner.hide();
        });
    ...
    getTransferLiat() {
        ...
        this.service.postApi('admin/transferCategoryList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.transferLists = res.body.result.docs ? res.body.result.docs : res.body.result;
                console.log('transferLists==>>', this.transferLists);
            }
            else {
                this.spinner.hide();
            }
    ...
    getTransferTypeLiat() {
        ...
        this.service.postApi('admin/transferTypeList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                console.log("this is the request id -=0-=-=-=-=", res);
                this.spinner.hide();
                // this.getName()
                this.transferTypeLists = res.body.result.docs ? res.body.result.docs : res.body.result;
                console.log('transferTypeLists==>>', this.transferTypeLists);
            }
            else {
                this.spinner.hide();
            }
    ...
    cartypeList() {
        ...
        this.service.postApi('admin/carTypeList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.cartTypeLists = res.body.result.docs ? res.body.result.docs : res.body.result;
                console.log('cartTypeLists==>>', this.cartTypeLists);
            }
            else {
                this.spinner.hide();
            }
...
AddPackageManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] },
    { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"] }
];
AddPackageManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-package-management',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-package-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/add-package-management/add-package-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-package-management.component.css */ "./src/app/add-package-management/add-package-management.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddSubAdminManagementComponent", function() { return AddSubAdminManagementComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
...
let AddSubAdminManagementComponent = class AddSubAdminManagementComponent {
    constructor(service, router, formbuilder, spinner) {
        this.service = service;
        this.router = router;
        this.formbuilder = formbuilder;
    ...
    addSubAdmin() {
        ...
        this.service.postApi('admin/addSubAdmin', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Sub-admin has been added successfully.");
...
AddSubAdminManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"] }
];
AddSubAdminManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-sub-admin-management',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-sub-admin-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/add-sub-admin-management/add-sub-admin-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-sub-admin-management.component.css */ "./src/app/add-sub-admin-management/add-sub-admin-management.component.css")).default]
    })
...
/* harmony import */ var _customer_management_customer_management_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./customer-management/customer-management.component */ "./src/app/customer-management/customer-management.component.ts");
/* harmony import */ var _sub_admin_management_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sub-admin-management/sub-admin-management.component */ "./src/app/sub-admin-management/sub-admin-management.component.ts");
/* harmony import */ var _content_destination_content_destination_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./content-destination/content-destination.component */ "./src/app/content-destination/content-destination.component.ts");
/* harmony import */ var _add_customer_add_customer_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./add-customer/add-customer.component */ "./src/app/add-customer/add-customer.component.ts");
/* harmony import */ var _edit_customer_edit_customer_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./edit-customer/edit-customer.component */ "./src/app/edit-customer/edit-customer.component.ts");
/* harmony import */ var _add_sub_admin_management_add_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./add-sub-admin-management/add-sub-admin-management.component */ "./src/app/add-sub-admin-management/add-sub-admin-management.component.ts");
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./auth.guard */ "./src/app/auth.guard.ts");
/* harmony import */ var _edit_sub_admin_edit_sub_admin_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./edit-sub-admin/edit-sub-admin.component */ "./src/app/edit-sub-admin/edit-sub-admin.component.ts");
/* harmony import */ var _enquries_enquries_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./enquries/enquries.component */ "./src/app/enquries/enquries.component.ts");
/* harmony import */ var _edit_destination_edit_destination_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./edit-destination/edit-destination.component */ "./src/app/edit-destination/edit-destination.component.ts");
/* harmony import */ var _settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./settings-page/settings-page.component */ "./src/app/settings-page/settings-page.component.ts");
/* harmony import */ var _view_enquries_view_enquries_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./view-enquries/view-enquries.component */ "./src/app/view-enquries/view-enquries.component.ts");
/* harmony import */ var _edit_setting_edit_setting_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./edit-setting/edit-setting.component */ "./src/app/edit-setting/edit-setting.component.ts");
...
/* harmony import */ var _package_management_package_management_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./package-management/package-management.component */ "./src/app/package-management/package-management.component.ts");
/* harmony import */ var _add_package_management_add_package_management_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./add-package-management/add-package-management.component */ "./src/app/add-package-management/add-package-management.component.ts");
/* harmony import */ var _view_package_management_view_package_management_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./view-package-management/view-package-management.component */ "./src/app/view-package-management/view-package-management.component.ts");
/* harmony import */ var _edit_package_management_edit_package_management_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./edit-package-management/edit-package-management.component */ "./src/app/edit-package-management/edit-package-management.component.ts");
...
const routes = [
    ...
    { path: 'sidebar', component: _sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_4__["SidebarComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    ...
    { path: 'reset-password/:_id', component: _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_6__["ResetPasswordComponent"] },
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'customer-management', component: _customer_management_customer_management_component__WEBPACK_IMPORTED_MODULE_8__["CustomerManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'sub-admin-management', component: _sub_admin_management_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_9__["SubAdminManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'package-management', component: _package_management_package_management_component__WEBPACK_IMPORTED_MODULE_23__["PackageManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'add-package-management', component: _add_package_management_add_package_management_component__WEBPACK_IMPORTED_MODULE_24__["AddPackageManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'view-package-management/:id', component: _view_package_management_view_package_management_component__WEBPACK_IMPORTED_MODULE_25__["ViewPackageManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'edit-package-management/:_id', component: _edit_package_management_edit_package_management_component__WEBPACK_IMPORTED_MODULE_26__["EditPackageManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'content-destination', component: _content_destination_content_destination_component__WEBPACK_IMPORTED_MODULE_10__["ContentDestinationComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'add-customer', component: _add_customer_add_customer_component__WEBPACK_IMPORTED_MODULE_11__["AddCustomerComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'edit-customer/:_id', component: _edit_customer_edit_customer_component__WEBPACK_IMPORTED_MODULE_12__["EditCustomerComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'add-sub-admin-management', component: _add_sub_admin_management_add_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_13__["AddSubAdminManagementComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'edit-sub-admin/:_id', component: _edit_sub_admin_edit_sub_admin_component__WEBPACK_IMPORTED_MODULE_15__["EditSubAdminComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'enquries', component: _enquries_enquries_component__WEBPACK_IMPORTED_MODULE_16__["EnquriesComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'edit-destination/:id/:val', component: _edit_destination_edit_destination_component__WEBPACK_IMPORTED_MODULE_17__["EditDestinationComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'settings-page', component: _settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_18__["SettingsPageComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'view-enquries/:id', component: _view_enquries_view_enquries_component__WEBPACK_IMPORTED_MODULE_19__["ViewEnquriesComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'edit-setting/:id/:val/:value', component: _edit_setting_edit_setting_component__WEBPACK_IMPORTED_MODULE_20__["EditSettingComponent"] },
    { path: 'page-not-found', component: _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_21__["PageNotFoundComponent"] },
...
/* harmony import */ var _customer_management_customer_management_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./customer-management/customer-management.component */ "./src/app/customer-management/customer-management.component.ts");
/* harmony import */ var _sub_admin_management_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./sub-admin-management/sub-admin-management.component */ "./src/app/sub-admin-management/sub-admin-management.component.ts");
/* harmony import */ var _content_destination_content_destination_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./content-destination/content-destination.component */ "./src/app/content-destination/content-destination.component.ts");
/* harmony import */ var _csv_service_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./csv-service.service */ "./src/app/csv-service.service.ts");
/* harmony import */ var _add_customer_add_customer_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./add-customer/add-customer.component */ "./src/app/add-customer/add-customer.component.ts");
...
/* harmony import */ var _add_sub_admin_management_add_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./add-sub-admin-management/add-sub-admin-management.component */ "./src/app/add-sub-admin-management/add-sub-admin-management.component.ts");
/* harmony import */ var _edit_sub_admin_edit_sub_admin_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./edit-sub-admin/edit-sub-admin.component */ "./src/app/edit-sub-admin/edit-sub-admin.component.ts");
/* harmony import */ var _enquries_enquries_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./enquries/enquries.component */ "./src/app/enquries/enquries.component.ts");
/* harmony import */ var _edit_destination_edit_destination_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./edit-destination/edit-destination.component */ "./src/app/edit-destination/edit-destination.component.ts");
/* harmony import */ var _settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./settings-page/settings-page.component */ "./src/app/settings-page/settings-page.component.ts");
/* harmony import */ var _sanitize_html_pipe_pipe__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./sanitize-html-pipe.pipe */ "./src/app/sanitize-html-pipe.pipe.ts");
/* harmony import */ var _view_enquries_view_enquries_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./view-enquries/view-enquries.component */ "./src/app/view-enquries/view-enquries.component.ts");
/* harmony import */ var _viewenquries_viewenquries_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./viewenquries/viewenquries.component */ "./src/app/viewenquries/viewenquries.component.ts");
/* harmony import */ var _edit_setting_edit_setting_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./edit-setting/edit-setting.component */ "./src/app/edit-setting/edit-setting.component.ts");
...
/* harmony import */ var _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./my-profile/my-profile.component */ "./src/app/my-profile/my-profile.component.ts");
/* harmony import */ var _package_management_package_management_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./package-management/package-management.component */ "./src/app/package-management/package-management.component.ts");
/* harmony import */ var _add_package_management_add_package_management_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./add-package-management/add-package-management.component */ "./src/app/add-package-management/add-package-management.component.ts");
/* harmony import */ var _edit_package_management_edit_package_management_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./edit-package-management/edit-package-management.component */ "./src/app/edit-package-management/edit-package-management.component.ts");
/* harmony import */ var _view_package_management_view_package_management_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./view-package-management/view-package-management.component */ "./src/app/view-package-management/view-package-management.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _customer_management_customer_management_component__WEBPACK_IMPORTED_MODULE_18__["CustomerManagementComponent"],
            _sub_admin_management_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_19__["SubAdminManagementComponent"],
            _content_destination_content_destination_component__WEBPACK_IMPORTED_MODULE_20__["ContentDestinationComponent"],
            _add_customer_add_customer_component__WEBPACK_IMPORTED_MODULE_22__["AddCustomerComponent"],
            _edit_customer_edit_customer_component__WEBPACK_IMPORTED_MODULE_23__["EditCustomerComponent"],
            _add_sub_admin_management_add_sub_admin_management_component__WEBPACK_IMPORTED_MODULE_24__["AddSubAdminManagementComponent"],
            _edit_sub_admin_edit_sub_admin_component__WEBPACK_IMPORTED_MODULE_25__["EditSubAdminComponent"],
            _enquries_enquries_component__WEBPACK_IMPORTED_MODULE_26__["EnquriesComponent"],
            _edit_destination_edit_destination_component__WEBPACK_IMPORTED_MODULE_27__["EditDestinationComponent"],
            _settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_28__["SettingsPageComponent"],
            _sanitize_html_pipe_pipe__WEBPACK_IMPORTED_MODULE_29__["SanitizeHtmlPipePipe"],
            _view_enquries_view_enquries_component__WEBPACK_IMPORTED_MODULE_30__["ViewEnquriesComponent"],
            _viewenquries_viewenquries_component__WEBPACK_IMPORTED_MODULE_31__["ViewenquriesComponent"],
            _edit_setting_edit_setting_component__WEBPACK_IMPORTED_MODULE_32__["EditSettingComponent"],
            _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_33__["PageNotFoundComponent"],
            _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_34__["MyProfileComponent"],
            _package_management_package_management_component__WEBPACK_IMPORTED_MODULE_35__["PackageManagementComponent"],
            _add_package_management_add_package_management_component__WEBPACK_IMPORTED_MODULE_36__["AddPackageManagementComponent"],
            _edit_package_management_edit_package_management_component__WEBPACK_IMPORTED_MODULE_37__["EditPackageManagementComponent"],
            _view_package_management_view_package_management_component__WEBPACK_IMPORTED_MODULE_38__["ViewPackageManagementComponent"],
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContentDestinationComponent", function() { return ContentDestinationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
let ContentDestinationComponent = class ContentDestinationComponent {
    ...
    ngOnInit() {
        ...
        this.activate.params.subscribe(res => {
            ...
            this.val = Number(res.val);
            this.tabChangedFunc(this.val);
        });
    }
    // *******************Country List ********************//
    getCountry() {
    ...
    addDestination() {
        ...
        console.log('object==>>', object);
        this.service.postApi('admin/addDestination', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
    ...
    destinationList() {
        ...
        this.service.postApi('admin/destinationList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.destnList = res.body.result.docs ? res.body.result.docs : res.body.result;
            }
            else {
                this.spinner.hide();
            }
    ...
    // ***************************Delete method*******************************//
    deleteFunctions() {
        this.service.deleteApi('admin/deleteDestination/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.destinationList();
                this.service.showSuccess(res.body.response_message);
    ...
    getContentList() {
        ...
        this.service.postApi('static/staticContentList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.contentList = res.body.result.docs ? res.body.result.docs : res.body.result;
                this._id = this.contentList.filter(x => x._id).map(x => x._id);
    ...
    deletebanner(id) {
        ...
        $('#bannermodaldelete').modal({ backdrop: 'static', keyboard: false });
    }
    // ***************************Delete method*******************************//
    deletebanners() {
        this.service.deleteApi('admin/deleteBanner/' + this.banner_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.addBannerList();
                this.service.showSuccess(res.body.response_message);
    ...
    addBanner() {
        ...
        if (this.imageSrc != null) {
            ...
            this.service.postApi('admin/addBanner', object, 1).subscribe(res => {
                if (res.body.response_code == 200) {
                    this.spinner.hide();
                    this.addBannerList();
                    this.bannerForm.reset();
                    this.imageSrc = '';
                    this.service.showSuccess("Banner has been added successfully.");
                }
                else if (res.body.response_code == 209) {
                    this.spinner.hide();
                    this.service.toastErr(res.body.response_message);
    ...
    addBannerList() {
        ...
        this.service.postApi('admin/bannerList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.bannerList = res.body.result.docs;
...
ContentDestinationComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
ContentDestinationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-content-destination',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./content-destination.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/content-destination/content-destination.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./content-destination.component.css */ "./src/app/content-destination/content-destination.component.css")).default]
    })
...
let CsvServiceService = class CsvServiceService {
    downloadFile(data, filename = 'data') {
        let csvData = this.ConvertToCSV(data, ['Name', 'Email address', 'Mobile number', 'Registration on']);
        console.log(csvData);
...
CsvServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], CsvServiceService);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _csv_service_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../csv-service.service */ "./src/app/csv-service.service.ts");
...
let CustomerManagementComponent = class CustomerManagementComponent {
    constructor(service, router, formBuilder, csvServiceService, spinner) {
        this.service = service;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    customerList() {
        ...
        this.service.postApi('admin/listCustomers', object, 1).subscribe(res => {
            console.log('res==>>', res);
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.customerLists = res.body.result.docs.map(item => {
                    let tempObj = item;
    ...
    download() {
        let dataArr = [];
        console.log('customerLists==>>>', this.customerLists);
        this.customerLists.forEach((element, ind) => {
            dataArr.push({
                "S no": ind + 1,
    ...
    deleteFunctions() {
        this.spinner.show();
        this.service.deleteApi('admin/deleteCustomer/' + this.user_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.customerList();
                this.spinner.hide();
                this.service.showSuccess("Customer has been deleted successfully.");
                this.customerList();
            }
            else {
                this.spinner.hide();
    ...
    selectHandler(item) {
        ...
        let tempArray = this.customerLists.map(element => {
        ...
        this.FilteredArray = tempArray.filter(ele => ele.isChecked);
...
CustomerManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] },
...
CustomerManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./customer-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/customer-management/customer-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./customer-management.component.css */ "./src/app/customer-management/customer-management.component.css")).default]
    })
...
let EditCustomerComponent = class EditCustomerComponent {
    constructor(service, router, formbuilder, activate, spinner) {
        this.service = service;
        this.router = router;
        this.formbuilder = formbuilder;
        this.activate = activate;
    ...
    viewCustomer() {
        ...
        this.service.postApi('admin/viewCustomer', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.patchvalues = res.body.result;
                console.log('patchvalues==>>', this.patchvalues.name);
                this.editCustomerForm.patchValue({
                    'name': this.patchvalues.name,
                    'email': this.patchvalues.email,
                    'number': this.patchvalues.mobileNumber,
                    'address': this.patchvalues.address,
                });
            }
            else {
                this.service.toastErr(res.body.response_message);
    ...
    editCustomer() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editCustomer', object, 1).subscribe(res => {
            console.log('resss==>>', res);
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Customer has been updated successfully.");
                this.router.navigate(['customer-management']);
            }
            else {
                this.spinner.hide();
...
EditCustomerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-customer.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/edit-customer/edit-customer.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-customer.component.css */ "./src/app/edit-customer/edit-customer.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditDestinationComponent", function() { return EditDestinationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/fesm2015/ngx-spinner.js");
...
let EditDestinationComponent = class EditDestinationComponent {
    // tab: string;
    // id: string;
    constructor(service, formBuilder, spinner, router, activate) {
        this.service = service;
    ...
    // *************************get destination********************//
    viewDestination() {
        this.service.getApi('admin/viewDestination/' + this.id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.viewdestinationData = res.body.result;
                console.log('ressview===>>>', this.viewdestinationData);
                this.destinationForm.patchValue({
                    'country': this.viewdestinationData.countryId,
                    'destination': this.viewdestinationData.destination,
                    'insurance': this.viewdestinationData.insurance,
                    'activeInsurance': this.viewdestinationData.status,
                });
            }
            else {
                this.spinner.hide();
    ...
    updateDestination() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editDestination', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Destination has been updated successfully.");
                this.router.navigate(['content-destination']);
            }
            else {
                this.spinner.hide();
                // this.service.toastErr(res.body.response_message)
    ...
    viewwebsite() {
        ...
        this.service.postApi('static/viewStaticContent', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.viewwebsiteData = res.body.result;
                console.log('viewwebsiteData===>>>', this.viewwebsiteData);
                this.editorForm.patchValue({
                    'title': this.viewwebsiteData.title,
                    'description': this.viewwebsiteData.description,
                });
            }
            else {
                this.spinner.hide();
    ...
    updatewebsite() {
        ...
        this.service.postApi('static/editStaticContent', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                ...
                this.service.showSuccess("Destination has been updated successfully.");
                let tab = '1';
                this.router.navigate(['content-destination', { val: 1 }]);
            }
            else {
                this.spinner.hide();
                this.service.toastErr(res.body.response_message);
    ...
    // *************************get banner********************//
    viewbanner() {
        this.service.getApi('admin/viewBanner/' + this.id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.viewbannerData = res.body.result;
                this.bannerImage = res.body.result.bannerPic;
                console.log('bannerImage===>>>', this.bannerImage);
                console.log('viewbannerData===>>>', this.viewbannerData);
                this.bannerForm.patchValue({
                    'activeInsurance': this.viewbannerData.status,
                    'title': this.viewbannerData.title,
                });
            }
            else {
                this.spinner.hide();
    ...
    updatebanner() {
        ...
        this.service.putApi('admin/editBanner', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Banner has been updated successfully.");
                this.router.navigate(['content-destination', { val: 2 }]);
            }
            else {
                this.spinner.hide();
                this.service.toastErr(res.body.response_message);
...
EditDestinationComponent.ctorParameters = () => [
...
EditDestinationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-destination',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-destination.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/edit-destination/edit-destination.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-destination.component.css */ "./src/app/edit-destination/edit-destination.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditPackageManagementComponent", function() { return EditPackageManagementComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _csv_service_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../csv-service.service */ "./src/app/csv-service.service.ts");
...
let EditPackageManagementComponent = class EditPackageManagementComponent {
    constructor(service, router, formBuilder, csvServiceService, spinner, param) {
        this.service = service;
        this.router = router;
        this.formBuilder = formBuilder;
        this.csvServiceService = csvServiceService;
        ...
        this.store = [];
        this.editorValue = '';
        this.param.params.subscribe(success => {
    ...
    viewData() {
        this.service.getApi('admin/viewPackage/' + this.id, 1).subscribe(res => {
            ...
            if (res.body.response_code == 200) {
                ...
                this.service.showSuccess(res.body.response_message);
                this.store = res.body.result;
                console.log('viewvalue===========>>', this.store);
                this.addpackageForm.patchValue({
                    "packagePicture": this.profile,
                    "country": this.store.country,
                    "destinationId": this.store.countryId,
                    "packageTypeId": this.store.packagetype,
                    "transferTypeId": [this.store.Transferstype],
                    "transferCategoryId": [this.store.Transferscategory],
                    "carTypeId": [this.store.Cartype],
                    "packagename": this.store.country,
                    "packageDays": this.store.packagedays,
                    "packageNights": this.store.packagenight,
                    "packageDescription": this.editorValue,
                    "flightsIncluded": this.store.value.flightsincluded,
                    "hotelsIncluded": this.store.value.Hotelsincluded,
                    "transferIncluded": this.store.value.Transfersincluded,
                    "sightseeingIncluded": this.store.value.Sightseeingincluded,
                    "ownerName": this.store.value.Ownername,
                    "ownerContact": this.store.value.Ownercontact,
                    "pricePerNight": this.store.value.Pricepernight,
                    "itinery": [{ 'arrive': "9", 'meal': "9", 'description': 'jhb' }, { 'arrive': "0", 'meal': "9", 'description': 'kjj' }],
                    "exclusions": [this.store.value.Exclusions],
                    "packageInclusion": [this.store.value.Packageinclusions],
                    "termsAndConditions": this.store.value.Terms,
                    "packageCost": [{ 'hotelCategory': "9", 'hotelName': 'ads', 'pricePerAdult': 1950 },
                        { 'hotelCategory': "9", 'hotelName': 'ads', 'pricePerAdult': 1950 }],
                    "cancellationCharge": [this.store.value.Cancellationcharges],
                });
            }
            else {
                this.spinner.hide();
    ...
    editpackage() {
        ...
        this.service.postApi('​admin​/editPackage', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Package-Management has been updated successfully.");
                this.router.navigate(['package-management']);
            }
            else {
                this.spinner.hide();
...
EditPackageManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
EditPackageManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-package-management',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-package-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/edit-package-management/edit-package-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-package-management.component.css */ "./src/app/edit-package-management/edit-package-management.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditSettingComponent", function() { return EditSettingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
...
let EditSettingComponent = class EditSettingComponent {
    constructor(service, formBuilder, spinner, router, activate) {
        this.service = service;
        this.formBuilder = formBuilder;
        this.spinner = spinner;
    ...
    ngOnInit() {
        this.activate.params.subscribe(res => {
            this.id = res.id;
            this.val = Number(res.val);
            this.value = Number(res.value);
            this.tabChangedFunc(this.val);
            this.tabChangedFuncs(this.value);
    ...
    // **********************View package api*************************//
    getViewPackage() {
        this.service.getApi('admin/viewPackageType/' + this.id, 1).subscribe(res => {
            this.viewPackage = res.body.result;
            console.log('viewPackage==>>', this.viewPackage);
            this.packageForm.patchValue({
                'country': this.viewPackage.countryId,
                'type': this.viewPackage.type,
                'activeInsurance': this.viewPackage.status,
            });
        });
    }
    // ***********************Package Add Api*****************//
    UpadePackage() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editPackageType', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Package type has been updated successfully.");
                this.router.navigate(['settings-page', { val: 0 }]);
            }
            else {
                this.spinner.hide();
                // this.service.toastErr(res.body.response_message)
    ...
    // **********************View trancsfer api*************************//
    getViewTransfer() {
        this.service.getApi('admin/viewTransferCategory/' + this.id, 1).subscribe(res => {
            this.viewTrancfer = res.body.result;
            console.log('viewTrancfer==>>', this.viewTrancfer);
            this.transfrForm.patchValue({
                'category': this.viewTrancfer.category,
                'activeInsurance': this.viewTrancfer.status,
            });
        });
    }
    // ***********************Package Add Api*****************//
    UpadeTrancsfr() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editTransferCategory', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.router.navigate(['settings-page', { val: 1, value: 0 }]);
                this.service.showSuccess("Transfer category has been updated successfully.");
            }
            else {
                this.spinner.hide();
                // this.service.toastErr(res.body.response_message)
    ...
    getViewTransferType() {
        this.service.getApi('admin/viewTransferType/' + this.id, 1).subscribe(res => {
            this.viewTrancferType = res.body.result;
            console.log('viewTrancferType==>>', this.viewTrancferType);
            this.TransferTypeForm.patchValue({
                'type': this.viewTrancferType.type,
                'activeInsurance': this.viewTrancferType.status
            });
        });
    }
    ...
    UpadeTrancsfrType() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editTransferType', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Transfer type has been updated successfully.");
                this.router.navigate(['settings-page', { val: 1, value: 1 }]);
            }
            else {
                this.spinner.hide();
                // this.service.toastErr(res.body.response_message)
    ...
    getViewCarType() {
        this.service.getApi('admin/viewCarType/' + this.id, 1).subscribe(res => {
            this.viewCarType = res.body.result;
            console.log('viewCarType==>>', this.viewCarType);
            this.carTypeForm.patchValue({
                'country': this.viewCarType.countryId,
                'destination': this.viewCarType.destinationId,
                'type': this.viewCarType.carType,
                'price': this.viewCarType.price,
                'activeInsurance': this.viewCarType.status,
            });
        });
    }
    // ***********************Package Add Api*****************//
    updateCarType() {
        ...
        console.log('object==>>', object);
        this.service.postApi('admin/addCarType', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.carType = res.body.result.docs;
                this.spinner.hide();
                this.router.navigate(['settings-page', { val: 2 }]);
                this.service.showSuccess("Car type has been updated successfully.");
            }
            else {
                this.spinner.hide();
                this.service.toastErr(res.body.response_message);
    ...
    getViewCountry() {
        ...
        this.service.getApi('admin/viewCountry/' + this.id, 1).subscribe(res => {
            this.viewcountry = res.body.result;
            console.log('viewcountry==>>', this.viewcountry);
            this.countryForm.patchValue({
                'country': this.viewcountry.country,
                'activeInsurances': this.viewcountry.status,
            });
        });
    }
    // ************************edit country api******************//
    UpadeCountry() {
        ...
        console.log('object==>>', object);
        this.service.putApi('admin/editCountry', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Country has been updated successfully.");
                this.router.navigate(['settings-page', { val: 3 }]);
            }
            else {
                this.spinner.hide();
                // this.service.toastErr(res.body.response_message)
    ...
    countryDataList() {
        ...
        this.service.postApi('admin/countryList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.countryData = res.body.result.docs ? res.body.result.docs : res.body.result;
    ...
    getTransferLiat() {
        ...
        this.service.postApi('admin/transferCategoryList', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.getName()
                this.transferLists = res.body.result.docs;
                console.log('transferLists==>>', this.transferLists);
            }
            else {
                this.spinner.hide();
...
EditSettingComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__["OrbisturServiceService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
...
EditSettingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-setting',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-setting.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/edit-setting/edit-setting.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-setting.component.css */ "./src/app/edit-setting/edit-setting.component.css")).default]
    })
...
let EditSubAdminComponent = class EditSubAdminComponent {
    constructor(service, router, formbuilder, spinner, activate) {
        this.service = service;
        this.router = router;
        this.formbuilder = formbuilder;
        this.spinner = spinner;
    ...
    // ***************************View Sub Admin Api***************************//
    viewAdmin() {
        this.service.getApi('admin/viewSubAdmin/' + this.ediradmin_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess(res.body.response_message);
                this.adminPatchvalues = res.body.result;
                console.log('adminPatchvalue==>>', this.adminPatchvalues);
                this.editSubAdminForm.patchValue({
                    'name': this.adminPatchvalues.name,
                    'email': this.adminPatchvalues.email,
                    'number': this.adminPatchvalues.mobileNumber,
                    'address': this.adminPatchvalues.address,
                    'dashboard': this.adminPatchvalues.permissions[0].dashboard,
                    'customerManagement': this.adminPatchvalues.permissions[0].customerManagement,
                    'subAdminManagement': this.adminPatchvalues.permissions[0].subAdminManagement,
                    'packageManagement': this.adminPatchvalues.permissions[0].packageManagement,
                    'bookingManagement': this.adminPatchvalues.permissions[0].bookingManagement,
                    'transferManagement': this.adminPatchvalues.permissions[0].transferManagement,
                    'sightseeingManagement': this.adminPatchvalues.permissions[0].sightseeingManagement,
                    'transactionManagement': this.adminPatchvalues.permissions[0].transactionManagement,
                    'visaManagement': this.adminPatchvalues.permissions[0].visaManagement,
                    'contentManagement': this.adminPatchvalues.permissions[0].contentManagement,
                    'inquiryManagement': this.adminPatchvalues.permissions[0].inquiryManagement,
                    'supportManagement': this.adminPatchvalues.permissions[0].supportManagement,
                    'settingManagement': this.adminPatchvalues.permissions[0].settingManagement,
                    'profilePic': this.adminPatchvalues.permissions[0].profilePic
                });
            }
            else {
                this.spinner.hide();
    ...
    editSubAdmin() {
        ...
        // console.log('dashboard==>>',object)
        console.log('valid', this.editSubAdminForm.valid);
        this.service.putApi('admin/editSubAdmin', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Sub-admin has been updated successfully.");
                this.router.navigate(['sub-admin-management']);
            }
            else {
                this.spinner.hide();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EnquriesComponent", function() { return EnquriesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
...
let EnquriesComponent = class EnquriesComponent {
    constructor(service, router, formBuilder, csvServiceService, spinner) {
        this.service = service;
        this.router = router;
        this.formBuilder = formBuilder;
        ...
        this.page = 1;
        this.p = 0;
        this.paginationData = { limit: 10, page: 1, total: 0 };
        this.dataArr = [];
        this.searchname = [];
    }
    ngOnInit() {
    ...
    enqList() {
        ...
        this.service.postApi('admin/inquiryList', object, 1).subscribe(res => {
            // console.log('res==>>',res) 
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.service.showSuccess(res.body.response_message) 
                // this.enqLists=res.body.result.docs?res.body.result.docs:res.body.result  
                this.length = res.body.result;
                this.enquiryList = res.body.result.docs;
                this.paginationData.total = this.length.length;
                console.log("hsdfgdsfg", this.enquiryList);
                this.total = res.body.result.total;
            }
            else if (res.body.response_code == 404) {
                this.spinner.hide();
                this.enquiryList = res.body.result;
                console.log("asdasdasdasdas", this.enquiryList);
            }
            else {
                this.spinner.hide();
                this.service.toastErr(res.body.response_message);
    ...
    // ***************************Delete method*******************************//
    deleteFunctions() {
        this.service.deleteApi('admin/deleteInquiry/' + this.user_id, 1).subscribe(res => {
            console.log("del", res);
            if (res.body.response_code == 200) {
                this.enqList();
                this.spinner.hide();
...
EnquriesComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_3__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _csv_service_service__WEBPACK_IMPORTED_MODULE_5__["CsvServiceService"] },
...
EnquriesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-enquries',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./enquries.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/enquries/enquries.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./enquries.component.css */ "./src/app/enquries/enquries.component.css")).default]
    })
], EnquriesComponent);
...
let MyProfileComponent = class MyProfileComponent {
    ...
    getProfile() {
        this.service.getApi('admin/getProfile', 1).subscribe(res => {
            if (res.status == 200) {
                ...
                console.log("dfsgdfsgdsfg", this.name, this.mobilenumber);
                console.log('name', this.data);
                this.getprofileForm.patchValue({
    ...
    editProfile() {
        ...
        console.log('object', object);
        this.service.putApi('admin/editProfile', object, 1).subscribe(res => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrbisturServiceService", function() { return OrbisturServiceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let OrbisturServiceService = class OrbisturServiceService {
    constructor(http, toastr) {
        this.http = http;
        this.toastr = toastr;
        // ********************Local base url**********************//
        //  baseUrl = "http://172.16.6.162:1800/api/v1/";  
        this.websiteUrls = "http://172.16.6.170:4205/";
        // gfhasfhjashjasdshjas
        // ********************Stag base url**********************//
        this.baseUrl = "http://ec2-35-176-66-190.eu-west-2.compute.amazonaws.com:1505/api/v1/";
        // ***********************Country Json***********************//
...
OrbisturServiceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] }
];
OrbisturServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
let PackageManagementComponent = class PackageManagementComponent {
    constructor(service, router, formBuilder, csvServiceService, spinner) {
        this.service = service;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    packageList() {
        ...
        this.service.postApi('admin/packageList', object, 1).subscribe(res => {
            console.log('res==>>', res);
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.subAdminLists=res.body.result.docs?res.body.result.docs:res.body.result  
                this.packagelists = res.body.result.docs;
                console.log('packagelistspackagelists==>>>', this.packagelists);
                this.total = res.body.result.total;
    ...
    download() {
        ...
        this.packagelists.forEach((element, ind) => {
            dataArr.push({
                "S.No.": ind + 1,
    ...
    deleteFunctions() {
        this.spinner.show();
        this.service.deleteApi('admin/deletePackage/' + this.user_id, 1).subscribe(res => {
            console.log('delete id=========', res);
            if (res.body.response_code == 200) {
                this.packageList();
                this.spinner.hide();
                this.service.showSuccess("Package-Management has been deleted successfully.");
                this.packageList();
            }
            else {
                this.spinner.hide();
...
PackageManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] },
    { type: _csv_service_service__WEBPACK_IMPORTED_MODULE_5__["CsvServiceService"] },
...
PackageManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-package-management',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./package-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/package-management/package-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./package-management.component.css */ "./src/app/package-management/package-management.component.css")).default]
    })
...
let ResetPasswordComponent = class ResetPasswordComponent {
    constructor(service, router, activeRouter, fb, spinner) {
        this.service = service;
        this.router = router;
...
let SettingsPageComponent = class SettingsPageComponent {
    ...
    addPackage() {
        ...
        console.log('object==>>', object);
        this.service.postApi('admin/addPackageType', object, 1).subscribe(res => {
            console.log('resaddpac==>>', res);
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.service.showSuccess("Package type has been added successfully.");
                this.packageList();
    ...
    addCountry() {
        ...
        console.log('object==>>', object);
        this.service.postApi('admin/addCountry', object, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.countrydata = res.body.result.docs;
                this.spinner.hide();
                this.service.showSuccess(res.body.response_message);
                this.countryDataList();
            }
    ...
    // ***************************Delete method*******************************//
    deleteFunctions() {
        this.service.deleteApi('admin/deletePackageType/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.packageList();
                this.spinner.hide();
                this.service.showSuccess(res.body.response_message);
    ...
    // ***************************Delete method*******************************//
    deletetranceFertype() {
        this.service.deleteApi('admin/deleteTransferType/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.getTransferTypeLiat();
                this.service.showSuccess(res.body.response_message);
    ...
    // ***************************Delete method*******************************//
    deletetransferdata() {
        this.service.deleteApi('admin/deleteTransferCategory/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.getTransferLiat();
                this.service.showSuccess(res.body.response_message);
    ...
    // ***************************Delete method*******************************//
    deletetCartypedata() {
        this.service.deleteApi('admin/deleteCarType/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.cartypeList();
                this.spinner.hide();
                this.service.showSuccess(res.body.response_message);
    ...
    // ***************************Delete method*******************************//
    deletetCountriesdata() {
        this.service.deleteApi('admin/deleteCountry/' + this.destination_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.spinner.hide();
                this.countryDataList();
                this.service.showSuccess(res.body.response_message);
...
SettingsPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./settings-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/settings-page/settings-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./settings-page.component.css */ "./src/app/settings-page/settings-page.component.css")).default]
    })
...
let SubAdminManagementComponent = class SubAdminManagementComponent {
    ...
    subAdminList() {
        ...
        this.service.postApi('admin/subAdminList', object, 1).subscribe(res => {
            ...
            if (res.body.response_code == 200) {
                this.spinner.hide();
                // this.subAdminLists=res.body.result.docs?res.body.result.docs:res.body.result  
                this.subAdminLists = res.body.result.docs;
                this.total = res.body.result.total;
                console.log('total==>>>', this.total);
            }
            else {
    ...
    download() {
        let dataArr = [];
        this.subAdminLists.forEach((element, ind) => {
            dataArr.push({
                "S no": ind + 1,
                "Name": element.name ? element.name : '',
                "Email address": element.email ? element.email : 'N/A',
    ...
    deleteFunctions() {
        this.spinner.show();
        this.service.deleteApi('admin/deleteSubAdmin/' + this.user_id, 1).subscribe(res => {
            if (res.body.response_code == 200) {
                this.subAdminList();
                this.spinner.hide();
                this.service.showSuccess("Sub-admin has been deleted successfully.");
                this.subAdminList();
            }
            else {
                this.spinner.hide();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewEnquriesComponent", function() { return ViewEnquriesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ViewEnquriesComponent = class ViewEnquriesComponent {
    ...
    ngOnInit() {
        this.activate.params.subscribe(params => {
            this.id = params.id;
            console.log("jnujnojk ", this.id);
        });
        this.viewenquiry();
    }
    viewenquiry() {
        this.service.getApi('admin/viewInquiry/' + this.id, 1).subscribe(res => {
            console.log("hhhhhhhhh=======>", res);
            this.store = res.body.result;
            console.log('ress===>>', this.store);
        });
...
ViewEnquriesComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] }
];
ViewEnquriesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-view-enquries',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./view-enquries.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/view-enquries/view-enquries.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./view-enquries.component.css */ "./src/app/view-enquries/view-enquries.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewPackageManagementComponent", function() { return ViewPackageManagementComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orbistur-service.service */ "./src/app/orbistur-service.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ViewPackageManagementComponent = class ViewPackageManagementComponent {
    constructor(service, activate, route, formBuilder) {
        this.service = service;
        this.activate = activate;
        this.route = route;
...
ViewPackageManagementComponent.ctorParameters = () => [
    { type: _orbistur_service_service__WEBPACK_IMPORTED_MODULE_2__["OrbisturServiceService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] }
];
ViewPackageManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-view-package-management',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./view-package-management.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/view-package-management/view-package-management.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./view-package-management.component.css */ "./src/app/view-package-management/view-package-management.component.css")).default]
    })
...
ViewenquriesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./viewenquries.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/viewenquries/viewenquries.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./viewenquries.component.css */ "./src/app/viewenquries/viewenquries.component.css")).default]
    })
], ViewenquriesComponent);
...
module.exports = __webpack_require__(/*! /Users/mobiloitteuser/Desktop/Orbistur-sprint-2/orbistur-travel-website-design-development-19123647-angular/src/main.ts */"./src/main.ts");
