...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj, (err, success) => {
            if (err)
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj1, (err, success) => {
            if (err)
                console.log("Error is" + err)
            else
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj3, (err, success) => {
            if (err)
                console.log("Error is" + err)
            else
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj4, (err, success) => {
            console.log("kjhjjhjjj",err,success)
            if (err)
